    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('bi.store', $bita) }}">
                        @csrf
                        <div class="form-group row">
                            <label for="tiempo_prestado" class="col-md-4 col-form-label text-md-right">tiempo_prestado</label>
                            <div class="col-md-6">
                                <input id="tiempo_prestado" type="text" class="form-control @error('tiempo_prestado') is-invalid @enderror" name="tiempo_prestado" value="{{$bita->tiempo_prestado}}" required autocomplete="tiempo_prestado" autofocus>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="coordinador" type="time" class="form-control @error('coordinador') is-invalid @enderror" name="coordinador" value="{{ old('coordinador') }}" required autocomplete="coordinador" autofocus>
