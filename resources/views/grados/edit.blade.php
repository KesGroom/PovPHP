                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('grados.update' ,$grado) }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="nombre_grado" type="text" class="form-control @error('nombre_grado') is-invalid @enderror" name="nombre_grado" value="{{ $grado->nombre_grado }}" required autocomplete="nombre_grado" autofocus>
