                            ...
                            <div class="form-group row">
                                ...
                                <select class="form-control col-md-6" id="tipo_documento" name="tipo_documento"
                                    ...
                                    @if ($usuario->tipo_documento == 'Cedula de ciudadania')
                                        <option selected value="Cedula de ciudadania">{{ __('pov.TDCedula') }}
                                        <option>
                                        @else
                                    ...
                                    @if ($usuario->tipo_documento == 'Tarjeta de identidad')
                                        ...
                                        <option>
                                    @endif
                                    @if ($usuario->tipo_documento == 'Registro civil')
                                        <option selected value="Registro civil">{{ __('pov.TDRegistro') }}
                                        <option>
                                        @else
