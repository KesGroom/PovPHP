...
<div class="container mb-4">
    <div class="row justify-content-center">
        <div class="col-md-6">
            <div class="card">
                <div class="card-header"><i class="fas fa-people-carry mr-2"></i>{{ __('pov.registerZona') }}</div>
                <div class="card-body">
                    <form method="POST" action="{{ route('zonas.store') }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-12">
                                <input id="nombre_zona" type="text"
                                    ...
                                    value="{{ old('nombre_zona') }}" required autocomplete="nombre_zona" autofocus>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-12">
                                <input id="lugar" type="text" class="form-control @error('lugar') is-invalid @enderror"
                                    name="lugar" value="{{ old('lugar') }}" required autocomplete="lugar" autofocus>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-12">
                                <input id="encargado" type="text"
                                    ...
                                    value="{{ old('encargado') }}" required autocomplete="encargado" autofocus>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-12">
                                <input id="hora_entrada" type="time"
                                    ...
                                    value="{{ old('hora_entrada') }}" required autocomplete="hora_entrada" autofocus>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-12">
                                <input id="hora_salida" type="time"
                                    ...
                                    value="{{ old('hora_salida') }}" required autocomplete="hora_salida" autofocus>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-12">
                                <input id="tiempo_servicio" type="text"
                                    ...
                                    name="tiempo_servicio" value="{{ old('tiempo_servicio') }}" required
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-12">
                                <input id="cupos" type="text" class="solo-numero form-control @error('cupos') is-invalid @enderror"
                                    name="cupos" value="{{ old('cupos') }}" required autocomplete="cupos" autofocus>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-12">
                                <textarea id="labores" rows="6"
                                    ...
                                    value="{{ old('labores') }}" required autocomplete="labores" autofocus>
                                </textarea>
                                @error('labores')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-12">
                                <input id="dias_servicio" type="text" placeholder="{{ __('pov.txtExampleDays') }}"
                                    ...
                                    name="dias_servicio" value="{{ old('dias_servicio') }}" required
