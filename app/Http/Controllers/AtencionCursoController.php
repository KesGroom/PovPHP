...
class AtencionCursoController extends Controller
{
    public function create(){
        ...
        ->get();
        return view('atencion_curso.create', compact('docente'));
    }
    public function DocenteCurso(Request $request){
      ...
      $Atencion_curso->save();
        $status = 'Se ha creado una nueva atencion por Curso';
        return back()->with(compact('status'));
      }
      public function index(){
        $AtencionCurso =  Atencion_curso::where('estado','Activo')
        ->get();
        return View('atencion_curso.index', compact('AtencionCurso'));
      }
      public function edit(Atencion_curso $ac){
        ...
        ->groupBy('users.id','users.name','users.apellido')
        ->get();
        return view('atencion_curso.edit', compact('ac','docente'));
    }
    public function update(Request $request,Atencion_curso $ac){
        ...
        $ac->save();
        $status = 'Se ha actualizado la atencion de curso';
        return back()->with(compact('status'));
      }
